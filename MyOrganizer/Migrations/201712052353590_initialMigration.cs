namespace MyOrganizer.Migrations
{
    ...
    public partial class initialMigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MeetingDate = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AddressBooks", "ApplicationUser_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.AddressBooks", new[] { "ApplicationUser_Id" });
